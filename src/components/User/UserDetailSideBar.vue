<script setup>
  ...
  const userLogin = computed(() => {
    return ticketList.value.length ? ticketList.value[0].user : {};
  });
</script>
  ...
  <div class="col-lg-4 col-md-4 margin-top-0">
    ...
    <div class="boxed-widget margin-top-30 margin-bottom-50">
      ...
      <ul class="listing-details-sidebar">
        <li><i class="sl sl-icon-phone"></i> {{ userLogin.phone }}</li>
        <li><i class="fa fa-envelope-o"></i> <a href="#">{{ userLogin.email }}</a></li>
      </ul>
